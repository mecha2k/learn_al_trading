...
if __name__ == "__main__":
    ...
    buy_sum_qty = (
        0  # Summation of buy_trade_qty for every buy Trade made since last time being flat
    )
    ...
    sell_sum_qty = (
        0  # Summation of sell_trade_qty for every sell Trade made since last time being flat
    )
    ...
    APO_VALUE_FOR_SELL_ENTRY = (
        10  # APO trading signal value above which to enter sell-orders/short-position
    )
    ...
    data.to_csv("../data/basic_mean_reversion.csv", sep=",")
